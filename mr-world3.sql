...
--
-- Host: 172.16.1.2    Database: world3
-- ------------------------------------------------------
-- Server version	11.6.2-MariaDB-ubu2404

drop database if exists world3;
create database world3;
use world3;
...
) ENGINE=InnoDB AUTO_INCREMENT=4080 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
...
CREATE TABLE `countries_languages` (
  `country_id` varchar(3) NOT NULL DEFAULT '',
  `language_id` varchar(30) NOT NULL DEFAULT '',
  `is_official` enum('T','F') NOT NULL DEFAULT 'F',
  `percentage` decimal(4,1) NOT NULL DEFAULT 0.0,
  PRIMARY KEY (`country_id`,`language_id`),
  KEY `country_code` (`country_id`),
  KEY `language_id` (`language_id`),
  CONSTRAINT `countries_languages_ibfk_1` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`),
  CONSTRAINT `countries_languages_ibfk_2` FOREIGN KEY (`language_id`) REFERENCES `languages` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
...
('ALB','Albania','Europe','Southern Europe',28748.00,1912,3401200,71.6,3205.00,2500.00,'Shqiperia','Republic','Rexhep Mejdani',34,'AL'),
...
('ARG','Argentina','South America','South America',2780400.00,1816,37032000,75.1,340238.00,323310.00,'Argentina','Federal Republic','Fernando de la Rua',69,'AR'),
('ARM','Armenia','Asia','Middle East',29800.00,1991,3520000,66.4,1813.00,1627.00,'Hajastan','Republic','Robert Kotsarjan',126,'AM'),
...
('ATF','French Southern territories','Antarctica','Antarctica',7780.00,NULL,0,NULL,0.00,NULL,'Terres australes francaises','Nonmetropolitan Territory of France','Jacques Chirac',NULL,'TF'),
...
('AUT','Austria','Europe','Western Europe',83859.00,1918,8091800,77.7,211860.00,206025.00,'Osterreich','Federal Republic','Thomas Klestil',1523,'AT'),
('AZE','Azerbaijan','Asia','Middle East',86600.00,1991,7734000,62.9,4127.00,4100.00,'Azerbaycan','Republic','İlham Eliyev',144,'AZ'),
...
('BEN','Benin','Africa','Western Africa',112622.00,1960,6097000,50.2,2357.00,2141.00,'Benin','Republic','Mathieu Kerekou',187,'BJ'),
('BFA','Burkina Faso','Africa','Western Africa',274000.00,1960,11937000,46.7,2425.00,2201.00,'Burkina Faso','Republic','Blaise Compaore',549,'BF'),
...
('BLR','Belarus','Europe','Eastern Europe',207600.00,1991,10236000,68.0,13714.00,NULL,'Belarus','Republic','Aljaksandr Lukasenka',3520,'BY'),
...
('BOL','Bolivia','South America','South America',1098581.00,1825,8329000,63.7,8571.00,7967.00,'Bolivia','Republic','Hugo Banzer Suarez',194,'BO'),
...
('BVT','Bouvet Island','Antarctica','Antarctica',59.00,NULL,0,NULL,0.00,NULL,'Bouvetoya','Dependent Territory of Norway','Harald V',NULL,'BV'),
('BWA','Botswana','Africa','Southern Africa',581730.00,1966,1622000,39.3,4834.00,4935.00,'Botswana','Republic','Festus G. Mogae',204,'BW'),
('CAF','Central African Republic','Africa','Central Africa',622984.00,1960,3615000,44.0,1054.00,993.00,'Centrafrique/Be-Afrika','Republic','Ange-Felix Patasse',1889,'CF'),
...
('CIV','Cote d Ivoire','Africa','Western Africa',322463.00,1960,14786000,45.2,11345.00,10285.00,'Cote d Ivoire','Republic','Laurent Gbagbo',2814,'CI'),
...
('COD','Congo, The Democratic Republic of the','Africa','Central Africa',2344858.00,1960,51654000,48.8,6964.00,2474.00,'Republique Democratique du Congo','Republic','Joseph Kabila',2298,'CD'),
...
('COL','Colombia','South America','South America',1138914.00,1810,42321000,70.3,102896.00,105116.00,'Colombia','Republic','Andres Pastrana Arango',2257,'CO'),
...
('CPV','Cape Verde','Africa','Western Africa',4033.00,1975,428000,68.9,435.00,420.00,'Cabo Verde','Republic','Antonio Mascarenhas Monteiro',1859,'CV'),
('CRI','Costa Rica','North America','Central America',51100.00,1821,4023000,75.8,10226.00,9757.00,'Costa Rica','Republic','Miguel Ángel Rodriguez Echeverria',584,'CR'),
...
('CYP','Cyprus','Asia','Middle East',9251.00,1960,754700,76.7,9333.00,8246.00,'Kypros/Kibris','Republic','Glafkos Klerides',2430,'CY'),
('CZE','Czech Republic','Europe','Eastern Europe',78866.00,1993,10278100,74.5,55017.00,52037.00,'¸esko','Republic','Vaclav Havel',3339,'CZ'),
...
('DOM','Dominican Republic','North America','Caribbean',48511.00,1844,8495000,73.2,15846.00,15076.00,'Republica Dominicana','Republic','Hipolito Mejia Dominguez',587,'DO'),
('DZA','Algeria','Africa','Northern Africa',2381741.00,1962,31471000,69.7,49982.00,46966.00,'Al-Jaza ir/Algerie','Republic','Abdelaziz Bouteflika',35,'DZ'),
...
('ESP','Spain','Europe','Southern Europe',505992.00,1492,39441700,78.8,553233.00,532031.00,'Espana','Constitutional Monarchy','Juan Carlos I',653,'ES'),
...
('FRO','Faroe Islands','Europe','Nordic Countries',1399.00,NULL,43000,78.4,0.00,NULL,'Foroyar','Part of Denmark','Margrethe II',901,'FO'),
...
('GEO','Georgia','Asia','Middle East',69700.00,1991,4968000,64.5,6064.00,5924.00,'Sakartvelo','Republic','Eduard Sevardnadze',905,'GE'),
...
('GIN','Guinea','Africa','Western Africa',245857.00,1958,7430000,45.6,2352.00,2383.00,'Guinee','Republic','Lansana Conte',926,'GN'),
...
('GNB','Guinea-Bissau','Africa','Western Africa',36125.00,1974,1213000,49.0,293.00,272.00,'Guine-Bissau','Republic','Kumba Iala',927,'GW'),
...
('GRC','Greece','Europe','Southern Europe',131626.00,1830,10545700,78.4,120724.00,119946.00,'Ellada','Republic','Kostis Stefanopoulos',2401,'GR'),
...
('GRL','Greenland','North America','North America',2166090.00,NULL,56000,68.1,0.00,NULL,'Kalaallit Nunaat/Gronland','Part of Denmark','Margrethe II',917,'GL'),
...
('GUF','French Guiana','South America','South America',90000.00,NULL,181000,76.1,681.00,NULL,'Guyane francaise','Overseas Department of France','Jacques Chirac',3014,'GF'),
...
('HND','Honduras','North America','Central America',112088.00,1838,6485000,69.9,5333.00,4697.00,'Honduras','Republic','Carlos Roberto Flores Facusse',933,'HN'),
('HRV','Croatia','Europe','Southern Europe',56538.00,1991,4473000,73.7,20208.00,19300.00,'Hrvatska','Republic','Stipe Mesic',2409,'HR'),
('HTI','Haiti','North America','Caribbean',27750.00,1804,8222000,49.2,3459.00,3107.00,'Haiti/Dayti','Republic','Jean-Bertrand Aristide',929,'HT'),
('HUN','Hungary','Europe','Eastern Europe',93030.00,1918,10043200,71.4,48267.00,45914.00,'Magyarorszag','Republic','Ferenc Madl',3483,'HU'),
...
('IRL','Ireland','Europe','British Islands',70273.00,1921,3775100,76.8,75921.00,73132.00,'Ireland/Eire','Republic','Mary McAleese',1447,'IE'),
...
('ISL','Iceland','Europe','Nordic Countries',103000.00,1944,279000,79.4,8255.00,7474.00,'Island','Republic','Olafur Ragnar Grimsson',1449,'IS'),
('ISR','Israel','Asia','Middle East',21056.00,1948,6217000,78.6,97477.00,98577.00,'Yisra el Israil','Republic','Moshe Katzav',1450,'IL'),
...
('KHM','Cambodia','Asia','Southeast Asia',181035.00,1953,11168000,56.5,5121.00,5670.00,'Kampuchea','Constitutional Monarchy','Norodom Sihanouk',1800,'KH'),
...
('LBN','Lebanon','Asia','Middle East',10400.00,1941,3282000,71.3,17121.00,15129.00,'Lubnan','Republic','Emile Lahoud',2438,'LB'),
...
('LUX','Luxembourg','Europe','Western Europe',2586.00,1867,435700,77.1,16321.00,15519.00,'Luxembourg/Letzebuerg','Constitutional Monarchy','Henri',2452,'LU'),
...
('MEX','Mexico','North America','Central America',1958201.00,1810,98881000,71.5,414972.00,401461.00,'Mexico','Federal Republic','Vicente Fox Quesada',2515,'MX'),
...
('MLI','Mali','Africa','Western Africa',1240192.00,1960,11234000,46.7,2642.00,2453.00,'Mali','Republic','Alpha Oumar Konare',2482,'ML'),
...
('MOZ','Mozambique','Africa','Eastern Africa',801590.00,1975,19680000,37.5,2891.00,2711.00,'Mocambique','Republic','Joaquim A. Chissano',2698,'MZ'),
...
('NCL','New Caledonia','Oceania','Melanesia',18575.00,NULL,214000,72.8,3563.00,NULL,'Nouvelle-Caledonie','Nonmetropolitan Territory of France','Jacques Chirac',3493,'NC'),
...
('NIC','Nicaragua','North America','Central America',130000.00,1838,5074000,68.7,1988.00,2023.00,'Nicaragua','Republic','Arnoldo Aleman Lacayo',2734,'NI'),
...
('PAN','Panama','North America','Central America',75517.00,1903,2856000,75.5,9131.00,8700.00,'Panama','Republic','Mireya Elisa Moscoso Rodriguez',2882,'PA'),
('PCN','Pitcairn','Oceania','Polynesia',49.00,NULL,50,NULL,0.00,NULL,'Pitcairn','Dependent Territory of the UK','Elisabeth II',2912,'PN'),
('PER','Peru','South America','South America',1285216.00,1821,25662000,70.0,64140.00,65186.00,'Peru/Piruw','Republic','Valentin Paniagua Corazao',2890,'PE'),
...
('PRT','Portugal','Europe','Southern Europe',91982.00,1143,9997600,75.8,105954.00,102133.00,'Portugal','Republic','Jorge Sampaio',2914,'PT'),
('PRY','Paraguay','South America','South America',406752.00,1811,5496000,73.7,8444.00,9555.00,'Paraguay','Republic','Luis Ángel Gonzalez Macchi',2885,'PY'),
...
('PYF','French Polynesia','Oceania','Polynesia',4000.00,NULL,235000,74.8,818.00,781.00,'Polynesie francaise','Nonmetropolitan Territory of France','Jacques Chirac',3016,'PF'),
('QAT','Qatar','Asia','Middle East',11000.00,1971,599000,72.4,9472.00,8920.00,'Qatar','Monarchy','Hamad ibn Khalifa al-Thani',2973,'QA'),
('REU','Reunion','Africa','Eastern Africa',2510.00,NULL,699000,72.7,8287.00,7988.00,'Reunion','Overseas Department of France','Jacques Chirac',3017,'RE'),
('ROM','Romania','Europe','Eastern Europe',238391.00,1878,22455500,69.9,38158.00,34843.00,'Romania','Republic','Ion Iliescu',3018,'RO'),
...
('SEN','Senegal','Africa','Western Africa',196722.00,1960,9481000,62.2,4787.00,4542.00,'Senegal/Sounougal','Republic','Abdoulaye Wade',3198,'SN'),
...
('SLV','El Salvador','North America','Central America',21041.00,1841,6276000,69.7,11863.00,11203.00,'El Salvador','Republic','Francisco Guillermo Flores Perez',645,'SV'),
...
('STP','Sao Tome and Principe','Africa','Central Africa',964.00,1975,147000,65.3,6.00,NULL,'Sao Tome e Principe','Republic','Miguel Trovoada',3172,'ST'),
...
('SYC','Seychelles','Africa','Eastern Africa',455.00,1976,77000,70.4,536.00,539.00,'Sesel/Seychelles','Republic','France-Albert Rene',3206,'SC'),
...
('TCD','Chad','Africa','Central Africa',1284000.00,1960,7651000,50.5,1208.00,1102.00,'Tchad/Tshad','Republic','Idriss Deby',3337,'TD'),
('TGO','Togo','Africa','Western Africa',56785.00,1960,4629000,54.7,1449.00,1400.00,'Togo','Republic','Gnassingbe Eyadema',3332,'TG'),
...
('TJK','Tajikistan','Asia','Southern and Central Asia',143100.00,1991,6188000,64.1,1990.00,1056.00,'Tocikiston','Republic','Emomali Rahmonov',3261,'TJ'),
...
('TKM','Turkmenistan','Asia','Southern and Central Asia',488100.00,1991,4459000,60.9,4397.00,2000.00,'Turkmenostan','Republic','Saparmurad Nijazov',3419,'TM'),
('TMP','East Timor','Asia','Southeast Asia',14874.00,NULL,885000,46.0,0.00,NULL,'Timor Timur','Administrated by the UN','Jose Alexandre Gusmao',1522,'TP'),
...
('TUR','Turkey','Asia','Middle East',774815.00,1923,66591000,71.0,210721.00,189122.00,'Turkiye','Republic','Ahmet Necdet Sezer',3358,'TR'),
...
('UKR','Ukraine','Europe','Eastern Europe',603700.00,1991,50456000,66.0,42168.00,49677.00,'Ukrajina','Republic','Leonid Kutsma',3426,'UA'),
...
('URY','Uruguay','South America','South America',175016.00,1828,3337000,75.2,20831.00,19967.00,'Uruguay','Republic','Jorge Batlle Ibanez',3492,'UY'),
...
('VAT','Holy See (Vatican City State)','Europe','Southern Europe',0.40,1929,1000,NULL,9.00,NULL,'Santa Sede/Citta del Vaticano','Independent Church State','Johannes Paavali II',3538,'VA'),
...
('VEN','Venezuela','South America','South America',912050.00,1811,24170000,73.1,95023.00,88434.00,'Venezuela','Federal Republic','Hugo Chavez Frias',3539,'VE'),
...
('VNM','Vietnam','Asia','Southeast Asia',331689.00,1945,79832000,69.3,21929.00,22834.00,'Viet Nam','Socialistic Republic','Tran Duc Luong',3770,'VN'),
...
('YUG','Yugoslavia','Europe','Southern Europe',102173.00,1918,10640000,72.4,17000.00,NULL,'Jugoslavija','Federal Republic','Vojislav Kostunica',1792,'YU'),
...
(145,'Gence','AZE','Gence',299300),
(146,'Sumqayıt','AZE','Sumqayıt',283000),
(147,'Mingecevir','AZE','Mingecevir',93900),
...
(455,'Águas Lindas de Goias','BRA','Goias',89200),
...
(556,'Vina del Mar','CHL','Valparaiso',312493),
...
(670,'A Coruna (La Coruna)','ESP','Galicia',243402),
...
(680,'Pamplona [Iruna]','ESP','Navarra',180483),
...
(699,'Logrono','ESP','La Rioja',127093),
...
(773,'Las Pinas','PHL','National Capital Reg',472780),
...
(777,'Paranaque','PHL','National Capital Reg',449811),
...
(782,'Dasmarinas','PHL','Southern Tagalog',379520),
...
(806,'Binan','PHL','Southern Tagalog',201186),
...
(908,'Batumi','GEO','Adzaria [Atsara]',137700),
...
(1449,'Reykjavik','ISL','Hofudborgarsvaedi',109184),
...
(1794,'Nis','YUG','Central Serbia',175391),
(1795,'Pristina','YUG','Kosovo and Metohija',155496),
...
(1917,'Urumtsi [Urumqi]','CHN','Xinxiang',1310100),
...
(2450,'Siauliai','LTU','Siauliai',146563),
...
(2641,'Tlajomulco de Zuniga','MEX','Jalisco',123220),
...
(2811,'Baerum','NOR','Akershus',101340),
...
(3210,'Kosice','SVK','Vychodne Slovensko',241874),
(3211,'Presov','SVK','Vychodne Slovensko',93977),
...
(3443,'Tsernigiv','UKR','Tsernigiv',313000),
(3444,'Tserkasy','UKR','Tserkasy',309000),
...
(3451,'Tsernivtsi','UKR','Tsernivtsi',259000),
(3452,'Rivne','UKR','Rivne',245000),
(3453,'Krementsuk','UKR','Pultava',239000),
...
(3477,'Berdytsiv','UKR','Zytomyr',90000),
(3478,'Izmajil','UKR','Odesa',90000),
(3479,'Sostka','UKR','Sumy',90000),
(3480,'Uman','UKR','Tserkasy',90000),
(3481,'Brovary','UKR','Kiova',89000),
(3482,'Mukatseve','UKR','Taka-Karpatia',89000),
...
(3588,'Ufa','RUS','Baskortostan',1091200),
(3589,'Tseljabinsk','RUS','Tseljabinsk',1083200),
...
(3610,'Nabereznyje Tselny','RUS','Tatarstan',514700),
...
(3629,'Sotsi','RUS','Krasnodar',358600),
...
(3664,'Blagovestsensk','RUS','Amur',222000),
(3665,'Sahty','RUS','Rostov-na-Donu',221800),
...
(3685,'Miass','RUS','Tseljabinsk',166200),
...
(3692,'Salavat','RUS','Baskortostan',156800),
(3693,'Mytistsi','RUS','Moskova',155700),
...
(3704,'Balasiha','RUS','Moskova',132900),
...
(3711,'Kamysin','RUS','Volgograd',124600),
(3712,'Novotseboksarsk','RUS','Tsuvassia',123400),
(3713,'Tserkessk','RUS','Karatsai-Tserkessia',121700),
(3714,'Atsinsk','RUS','Krasnojarsk',121600),
(3715,'Magadan','RUS','Magadan',121000),
(3716,'Mitsurinsk','RUS','Tambov',120700),
...
(3722,'Novokuibysevsk','RUS','Samara',116200),
(3723,'Neftekamsk','RUS','Baskortostan',115700),
(3724,'Leninsk-Kuznetski','RUS','Kemerovo',113800),
(3725,'Oktjabrski','RUS','Baskortostan',111500),
...
(3736,'Stsolkovo','RUS','Moskova',104900),
(3737,'Mezduretsensk','RUS','Kemerovo',104400),
(3738,'Usolje-Sibirskoje','RUS','Irkutsk',103500),
(3739,'Elista','RUS','Kalmykia',103300),
(3740,'Novosahtinsk','RUS','Rostov-na-Donu',101900),
...
(3746,'Kinesma','RUS','Ivanovo',100000),
...
(3754,'Balasov','RUS','Saratov',97100),
...
('Ane',NULL,NULL),
('Arabic','ar','ara'),
('Arabic-French',NULL,NULL),
('Arabic-French-English',NULL,NULL),
('Araucan',NULL,NULL),
('Arawakan',NULL,NULL),
('Armenian',NULL,NULL),
('Asami',NULL,NULL),
...
('Bugi',NULL,NULL),
('Bulgariana','bg','bul'),
('Bullom-sherbro',NULL,NULL),
('Bura',NULL,NULL),
('Burmese','my','mya'),
('Buryat',NULL,NULL),
('Busansi',NULL,NULL),
('Cakchiquel',NULL,NULL),
('Canton Chinese',NULL,NULL),
('Caprivi',NULL,NULL),
('Caribbean',NULL,NULL),
('Carolinian',NULL,NULL),
('Catalan','ca','cat'),
('Cebuano',NULL,NULL),
('Chaga and Pare',NULL,NULL),
('Chakma',NULL,NULL),
('Chamorro',NULL,NULL),
('Chechen',NULL,NULL),
('Chewa',NULL,NULL),
...
('Chuabo',NULL,NULL),
('Chuvash',NULL,NULL),
('Circassian',NULL,NULL),
('Comorian',NULL,NULL),
('Comorian-Arabic',NULL,NULL),
('Comorian-French',NULL,NULL),
('Comorian-Swahili',NULL,NULL),
('Comorian-madagassi',NULL,NULL),
('Creole English',NULL,NULL),
('Creole French',NULL,NULL),
('Crioulo',NULL,NULL),
('Cuna',NULL,NULL),
('Czech','cs',NULL),
('Czech and Moravian',NULL,NULL),
('Dagara',NULL,NULL),
('Danish','da','dan'),
('Dari',NULL,NULL),
('Dariganga',NULL,NULL),
...
('Kalenjin',NULL,NULL),
('Kamba',NULL,NULL),
('Kanem-bornu',NULL,NULL),
('Kannada','kn','kan'),
('Kanuri',NULL,NULL),
('Karakalpak',NULL,NULL),
('Karen',NULL,NULL),
('Kavango',NULL,NULL),
('Kayah',NULL,NULL),
('Kazakh',NULL,NULL),
...
('Luguru',NULL,NULL),
('Luhya',NULL,NULL),
('Luimbe-nganguela',NULL,NULL),
('Luo',NULL,NULL),
('Luri',NULL,NULL),
('Luvale',NULL,NULL),
('Luxembourgish',NULL,NULL),
('Macedonian','mk','mkd'),
('Madura',NULL,NULL),
('Maguindanao',NULL,NULL),
('Mahore',NULL,NULL),
('Maithili',NULL,NULL),
('Maka',NULL,NULL),
('Makonde',NULL,NULL),
...
('Malajalam',NULL,NULL),
('Malay','ms','msa'),
('Malay-English',NULL,NULL),
('Malenasian Languages',NULL,NULL),
('Malinke',NULL,NULL),
('Maltese',NULL,NULL),
('Mam',NULL,NULL),
('Man',NULL,NULL),
('Mandara',NULL,NULL),
('Mandarin Chinese',NULL,NULL),
('Mandjia',NULL,NULL),
('Mandyako',NULL,NULL),
('Mano',NULL,NULL),
('Mantsu',NULL,NULL),
...
('Mari',NULL,NULL),
('Marma',NULL,NULL),
('Marshallese',NULL,NULL),
('Masai',NULL,NULL),
('Masana',NULL,NULL),
('Maya Languages',NULL,NULL),
('Mayo-kebbi',NULL,NULL),
('Mazandarani',NULL,NULL),
('Mbete',NULL,NULL),
('Mboshi',NULL,NULL),
('Mbum',NULL,NULL),
('Mbundu',NULL,NULL),
...
('Miao',NULL,NULL),
('Min',NULL,NULL),
('Minangkabau',NULL,NULL),
('Miskito',NULL,NULL),
('Mixed Languages',NULL,NULL),
('Mixtec',NULL,NULL),
('Moba',NULL,NULL),
('Mon',NULL,NULL),
('Mon-khmer',NULL,NULL),
('Monegasque',NULL,NULL),
('Mongo',NULL,NULL),
('Mongolian',NULL,NULL),
('Moravian',NULL,NULL),
('Mordva',NULL,NULL),
...
('Nepali','ne','nep'),
('Newari',NULL,NULL),
('Ngala and Bangi',NULL,NULL),
('Ngbaka',NULL,NULL),
('Ngoni',NULL,NULL),
('Niue',NULL,NULL),
('Nkole',NULL,NULL),
('Northsotho',NULL,NULL),
('Norwegian','no','nob'),
('Nsenga',NULL,NULL),
('Nubian Languages',NULL,NULL),
('Nuer',NULL,NULL),
('Nung',NULL,NULL),
('Nyakusa',NULL,NULL),
('Nyamwesi',NULL,NULL),
('Nyaneka-nkhumbi',NULL,NULL),
('Nyanja',NULL,NULL),
('Nyika',NULL,NULL),
('Orija',NULL,NULL),
('Oromo',NULL,NULL),
...
('Palau',NULL,NULL),
('Pampango',NULL,NULL),
('Pangasinan',NULL,NULL),
('Papiamento',NULL,NULL),
('Papuan Languages',NULL,NULL),
('Pashto','ps','pus'),
('Persian','fa','fas'),
('Philippene Languages',NULL,NULL),
('Pilipino',NULL,NULL),
('Pitcairnese',NULL,NULL),
('Pohnpei',NULL,NULL),
('Polish','pl','pol'),
('Polynesian Languages',NULL,NULL),
('Portuguese','pt','por'),
('Punjabi','pa','pan'),
('Punu',NULL,NULL),
('Punu-sira-nzebi',NULL,NULL),
('Puyi',NULL,NULL),
('Quiche',NULL,NULL),
('Rakhine',NULL,NULL),
('Rapa nui',NULL,NULL),
...
('Sardinian',NULL,NULL),
('Sena',NULL,NULL),
('Senufo and Minianka',NULL,NULL),
('Serbo-Croatian',NULL,NULL),
('Serer',NULL,NULL),
('Seselwa',NULL,NULL),
('Shambala',NULL,NULL),
('Shan',NULL,NULL),
...
('Somba',NULL,NULL),
('Songhai',NULL,NULL),
('Songhai-zerma',NULL,NULL),
('Soninke',NULL,NULL),
('Soqutri',NULL,NULL),
('Sotho',NULL,NULL),
('Southern Slavic Languages',NULL,NULL),
('Southsotho',NULL,NULL),
('Spanish','es','spa'),
('Sranantonga',NULL,NULL),
('Sumo',NULL,NULL),
('Sunda',NULL,NULL),
('Susu',NULL,NULL),
('Swahili','sw','swa'),
...
('Turkana',NULL,NULL),
('Turkish','tr','tur'),
('Turkmenian',NULL,NULL),
('Tuvalu',NULL,NULL),
('Udmur',NULL,NULL),
('Uighur',NULL,NULL),
('Ukrainian','uk','ukr'),
('Ukrainian and Russian',NULL,NULL),
('Urdu','ur','urd'),
('Uzbek',NULL,NULL),
('Venda',NULL,NULL),
('Vietnamese','vi','vie'),
...
-- Dump completed on 2025-08-05 12:13:12
